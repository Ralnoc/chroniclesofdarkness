...
local GameLine =
{ Name= "Geist",
  FullName = "Geist: The Sin-Eaters",
  MoralityTitle = "Synergy",
  FactionTitle = "Archetype",
  GroupTitle = "Threshold",
  CSLogo = "geist_button",
  FullLogo = nil,
  Skills =
  ...
  { Frame = "geist_sheet",
    ...
    Tabs = 
    { [1] = {Name="main", Template="geist_main", Icon="tab_main"},     
      [2] = {Name="other", Template="charsheet_other", Icon="tab_other"},
      [3] = {Name="special", Template="geist_special", Icon="tab_special"},
