...
local GameLine =
{ Name= "Mage",
  FullName = "Mage: The Awakening",
  MoralityTitle = "Wisdom",
  FactionTitle = "Path",
  GroupTitle = "Order",
  CSLogo = "mage_button",
  FullLogo = nil,
  ...
  { Frame = "mage_sheet",
    ...
    { [1] = {Name="main", Template="mage_main", Icon="tab_main"},
      ...
      [3] = {Name="special", Template="mage_special", Icon="tab_special"},
      [4] = {Name="rotes", Template="mage_rotes", Icon="tab_rotes"},
      [5] = {Name="familiar", Template="mage_familiar", Icon="tab_familiar"},
      [6] = {Name="notes", Template="charsheet_notes", Icon="tab_notes"},
      Activate = 1
    }
  },
  NPCSheet = nil,
